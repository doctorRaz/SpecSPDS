...
#endif
    {
        ...
        public void Initialize()
        {
            ...
            try
            {
                ...
                */
                //todo сперва проверить версию кад, если ниже чем минимальная, то не грузим аддон, а юзеру в месадж сообщаем
                //поднять версию net до 6.0 что бы сборка в младшие не грузилась

...
namespace dRz.SpecSpds.Test
{
    ...
    public class Start
    {
        ...
        private static void Main(string[] args)
        {
            ...
            var dd = AddonContext.InfoDll  .ProductName;
            Console.WriteLine(AddonContext.InfoDll.LongString());

            Console.WriteLine(AddonContext.InfoDll);


            //todo спросить AI насчет new, как лучше??
            ...
            var os2 = InfoOs.Current;
            //var os2 = InfoOsGPT.Current.ToString();

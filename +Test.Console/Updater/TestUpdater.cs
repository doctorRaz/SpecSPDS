...
namespace drz.Test.Logger.Updater

{
    internal class TestUpdater
    {
        ...
        public void Run()
        {
            ...
            Exception ex = new Exception("Properties is null");
            ...
            Msg.InfoMessage($"TestUpdater start");

            MsgGUI.InfoMessage("test");
...
//todo выбор интерфейсов через фабрику к контейнере
